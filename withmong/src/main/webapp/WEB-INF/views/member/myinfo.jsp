...
$(function() {
	if("${LOGIN_USER.grade}" == 'B'){
		$("#img").append("<img id='profile' alt='profile' src='resources/images/profile/${LOGIN_USER.img }' class='target' style='width:250px;height:250px;border:0;'>");
	...
	$.ajax({
		...
		success: function(data) {
			...
			$.each(data, function(index, item) {
				...
				product += "<p><a href='detail.do?productNo="+item.no+"' class='btn btn-primary' role='button'>상세보기</a><a href='updateProduct.do?productNo="+item.no+"' class='btn btn-default' role='button'>수정하기</a></p>";
				product += "</div></div></div>";
...
<body>
		...
		<div class="container" >
			<div class="row text-center">
	        	...
	        	<h2 class="glyphicon glyphicon-user" id="id"> ${LOGIN_USER.id}</h2>
