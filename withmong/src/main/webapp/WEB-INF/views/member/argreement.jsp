...
<div class="agreeArea">
	...
	<input type="button" name="agreebutton" value="전체선택" onclick="agreement();" class="btn btn-primary" />
	&nbsp;&nbsp;
	<input type="button" name="disagreebutton" value="전체해제" onclick="disagreement();" class="btn btn-danger" />
  </div>
</form>	
	<hr>
</body>
