	...
	<div class="container" >
		...
		<div class="panel panel-boby">
			<table class="table">
				...
				<tbody>
					<tr>
						<td rowspan="5"><img alt="회원사진" src="resources/images/profile/${userdetail.img } " width="300px;" height="300px"></td>
						<td>${userdetail.id }</td>
					...
					<tr>
						...
						<td><fmt:formatNumber value="${userdetail.point }" type="number"></fmt:formatNumber> <b>point</b></td>
					</tr>
				</tbody>
			</table>
		</div>
