...
<body>
	...
	<div class="container" id="chain">
		...
		<div style="text-align: right;">
			<a class="btn btn-warning" href="allProductList.do">전체</a>
			<a class="btn btn-warning" href="productlist.do?cno=1">교육</a>
			<a class="btn btn-warning" href="productlist.do?cno=2">취미</a>
			<a class="btn btn-warning" href="productlist.do?cno=3">대행서비스</a>
